...
<div class="content-wrapper">
        <section class="content">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Technology Info </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <div class="box-body">
                            <div class="row"> 
                                <form role="form" method="POST" action="{{route('developer.technologyStore')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-5">
            ...
            <div class="box-header">
              <h3 class="box-title">Technology List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   ...
                   <td class="text-center">{{$count++}}</td>
                    ...
                    <td class="text-center"><a class="btn btn-danger btn-sm" href="{{route('developer.technology_delete',$tech->id)}}">Delete</a></td>
                   </tr>
                 @endforeach
                </tbody>
              </table>
